...
gosperGliderGunDestructionString = "15bo31b$16bo30b$14b3o30b6$44bo2b$44bobo$obo11bo29b2ob$b2o11b4o29b$bo13b4o10b2o16b$4b2o9bo2bo9bobo16b$4b2o9b4o8b3o8b2o7b$14b4o8b3o9b2o7b$14bo12b3o17b$28bobo16b$6b2o21b2o16b$7b2o38b$6bo40b$37b2o8b$37bobo7b$37bo!"
gliderString = "bo$2bo$3o!"
gosperGliderGunString = "24bo$22bobo$12b2o6b2o12b2o$11bo3bo4b2o12b2o$2o8bo5bo3b2o$2o8bo3bob2o4bobo$10bo5bo7bo$11bo3bo$12b2o!"
theSmallestKnownPeriod60gun = "27bo11b$25bobo11b$15b2o6b2o12b2o$14bo3bo4b2o12b2o$3b2o8bo5bo3b2o14b$3b2o8bo3bob2o4bobo11b$13bo5bo7bo11b$14bo3bo20b$15b2o22b$26bo12b$27b2o10b$26b2o11b4$21b2o16b$9bobo10b2o15b$9bo2bo8bo17b$2o10b2o11b2o12b$2o8bo3b2o8bobo12b$5b2o5b2o9bo6b2o7b$4bo4bo2bo10bo2bo2bo2bo6b$9bobo11bo6b3o6b$24bobo5b3o4b$25b2o6bobo3b$35bo3b$35b2o!"
copperHead = "4b2o$3b4o2$2b6o$3b4o2$2b2o2b2o$2obo2bob2o$3bo2bo3$4b2o$4b2o!"
...
parseRleInternal input processed (row, col, rle) =
  let
    parser pattern = List.head (find (AtMost 1) (regex pattern) input)
    deadCell = parser "(\\d+)?b"
    aliveCell = parser "(\\d+)?o"
    endOfLine = parser "\\$"
  ...
  in
    if String.length input == 0 then
      ...
      Debug.crash "Too long pattern" (Just (row, col, rle))
    else
      case List.head <| List.filter (\(pattern, processor) -> firstPattern pattern) executionMapper of
        Just (Just pattern, processor) ->
          parseRleInternal (String.dropLeft (String.length pattern.match) input) 
            (processed + 1) (processor pattern (row, col, rle))
        _ ->
          let
            x = Debug.log "No match" input
          in
            parseRleInternal (String.dropLeft 1 input)
              (processed + 1) (row, col, rle)


firstPattern : Maybe Match -> Bool
firstPattern maybeMatch = mapWithDefault False (\match -> match.index == 0) maybeMatch


mapWithDefault : a -> (b -> a) -> Maybe b -> a
mapWithDefault default processor maybe =
  case maybe of
    Just value -> processor value
    Nothing -> default
...
processAliveCell match (row, col, rle) =
  let
    times = parseCellMultiplier match
  in
    (row
    , col + times
    , { rle
        | pattern = List.append rle.pattern
...
type alias Structure = (String, List (Int, Int))
